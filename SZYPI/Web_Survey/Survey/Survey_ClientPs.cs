...
{
    public class Survey_ClientPs : Page, IRequiresSessionState
    {
        ...
        Label_001B:
            ...
            dr = new Survey_ClientPs_Layer().GetSurveyExpand(SID);
            if ((1 != 0) && (0 != 0))
            {
            }
            int num = 3;
        ...
        Label_0017:
            ...
            SqlDataReader reader = new Survey_ClientPs_Layer().GetSurveyTable(SID.ToString());
            int num = 1;
        Label_0002:
            switch (num)
            {
        ...
        public void InitChoose()
        {
            ...
            if (FindAnswerGUID != "")
            {
                DataTable dt_GetAnswerDetail = new Survey_ClientPs_Layer().GetAnswerDetail(FindAnswerGUID, sid);
