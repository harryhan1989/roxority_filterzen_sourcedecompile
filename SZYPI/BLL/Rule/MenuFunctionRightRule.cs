...
namespace BLL
{
    ...
    /// 目的:
    /// </summary>
    public class MenuFunctionRightRule
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public MenuFunctionRightRule()
        {
        }
        ...
        public void Add(MenuFunctionRightEntity entity)
        {
        ...
        /// </summary>
        /// <param name = "entity">实体类</param>
        public void Update(MenuFunctionRightEntity entity)
        {
        ...
        /// </summary>
        /// <param name = "entity">实体类</param>
        public void Delete(MenuFunctionRightEntity entity)
        {
