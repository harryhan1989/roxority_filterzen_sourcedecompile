<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMenuVistor.aspx.cs" Inherits="WebManage.Web._12355WebVistor.FMenuVistor" %>
...
<body>
    ...
    <table id="Table1" class="ChartMenu" height="77" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <asp:Label ID="Label1" runat="server" Text="查看子模块访问频率"></asp:Label>
