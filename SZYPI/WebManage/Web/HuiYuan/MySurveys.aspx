<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MySurveys.aspx.cs" Inherits="WebManage.Web.HuiYuan.MySurveys" %>
      ...
      <div class="wdwj_top" runat="server" id="divTop"></div>
       ...
       <table>
        ...
        <tr>
            <td>
                <div class="left_mid">
                <div class="flagleft"><a href="#" onclick='window.open("../../Survey/ClientPs.aspx?answerguid=<%# DataBinder.Eval(Container.DataItem,"answerguid") %>&sid="+<%# DataBinder.Eval(Container.DataItem,"sid") %> )'><%# Eval("SurveyName")%></a></div>
                ...
                <div class="admin_uer">
                    ...
                    <span style="color:Blue; font-weight:bold;">已参与</span>
                    <span style="color:Red; font-weight:bold;"><%# Eval("ApprovalStausName")%></span>
                </div>
