<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MenuFunction.aspx.cs" Inherits="WebManage.Web.SystemManager.MenuFunction" %>
                ...
                <table cellpadding="2" cellspacing="2" align="center">
                    <tr>
                        ...
                        <td style="width: 160px;">
                            <asp:TextBox ID="txtFName" runat="server" Width="99%" MaxLength="40"></asp:TextBox>
                        </td>
                        ...
                        <td style="width: 160px;">
                            <asp:TextBox ID="txtFCode" runat="server" Width="97%" MaxLength="40"></asp:TextBox>
                        </td>
                        <td style="width: 20px; color: Red">
                            *
                        </td>
                    ...
                    <tr>
                        <td>
                            是否显示：</td>
                        <td>
                            <asp:RadioButtonList ID="rdoIsShow" runat="server" RepeatColumns="2">
                                <asp:ListItem Value="1" Selected="True">是</asp:ListItem>
                                <asp:ListItem Value="0">否</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                        <td align="center" style="width: 90px" colspan="4">
                            <asp:Button ID="btnSave" runat="server" Text="保存" CssClass="button70" Style="margin-left: 20px;"
                    ...
                    <tr>
                        <td valign="Top">
                            <ND:NDGridView ID="grid" runat="server" AllowSetRowStyle="True" AutoGenerateColumns="False"
                                ...
                                Width="100%" DataKeyNames="FID" OnRowCommand="grid_RowCommand">
                                <Columns>
                                    <asp:TemplateField>
                                        ...
                                        <itemtemplate>
                                            <asp:CheckBox id="chkItem" runat="server" onclick="SetIsAllChecked('grid_ctl01_chkItemAll', this, 'chkItem');" dataID='<%# Eval("FID") %>'></asp:CheckBox> 
                                        </itemtemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="FName" HeaderText="功能名称">
                                        <itemstyle width="40%" horizontalalign="Left" />
                                        <headerstyle width="40%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="FCode" HeaderText="代码名称">
                                        <itemstyle width="25%" horizontalalign="Left" />
                                        <headerstyle width="25%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="IsShowName" HeaderText="是否显示">
