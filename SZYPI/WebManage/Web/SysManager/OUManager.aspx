<%@ Page Language="C#" AutoEventWireup="true" Codebehind="OUManager.aspx.cs" Inherits="WebManage.Web.SystemManager.OUManager" %>
        ...
        function toolbar_Click(toolbarItem)
        {
            ...
            {	          
                case "Delete":
                   ...
                   break;
               case "Add":                   
//                    showModalWindow(closeid, "添加",width, height, "../../web/SysManager/OUDetail.aspx?Operation=1");
//                    toolbarItem.needPostBack = false;
                   //                    break;
