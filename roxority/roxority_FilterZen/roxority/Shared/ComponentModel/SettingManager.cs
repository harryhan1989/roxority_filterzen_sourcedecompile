namespace roxority.Shared.ComponentModel
{
    ...
    [ProvideProperty("SettingsName", typeof(IComponent)), ProvideProperty("SettingsUserScope", typeof(IComponent)), ProvideProperty("SettingsMachineScope", typeof(IComponent))]
    internal class SettingManager : Component, IExtenderProvider
    {
        ...
        [DefaultValue((string) null), ExtenderProvidedProperty, Localizable(false)]
